...
export const RESOURCE_BULK_DOWNLOAD_REQUEST = 'RESOURCE_BULK_DOWNLOAD_REQUEST';
export const RESOURCE_BULK_DOWNLOAD_SUCCESS = 'RESOURCE_BULK_DOWNLOAD_SUCCESS';
export const RESOURCE_BULK_DOWNLOAD_FAILURE = 'RESOURCE_BULK_DOWNLOAD_FAILURE';

export const resourceBulkDownloadRequest = (resource, params) => ({
  type: RESOURCE_BULK_DOWNLOAD_REQUEST,
  payload: { params },
  meta: {
    resource,
...
export const resourceBulkDownloadSuccess = (resource, detail, request, thunk) => ({
  type: RESOURCE_BULK_DOWNLOAD_SUCCESS,
  payload: detail,
  meta: {
    request,
    thunk,
...
export const resourceBulkDownloadFailure = (resource, error, request, thunk) => ({
  type: RESOURCE_BULK_DOWNLOAD_FAILURE,
  error: true,
  payload: error,
  meta: {
    request,
